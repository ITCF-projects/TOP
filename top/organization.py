...
from top.common import Tag, I18nText, TagsMixin, OptionalIdMixin, MandatoryIdMixin, EffectiveTimePeriodMixin

if TYPE_CHECKING:
    from top.deployment import Deployment
    from top.communication import Communication
    from top.responsibility import OrganizationResponsibility
    from top.work_life_cycle import OrganizationalHome
